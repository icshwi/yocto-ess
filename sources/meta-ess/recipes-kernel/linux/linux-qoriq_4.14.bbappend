FILESEXTRAPATHS_prepend := "${THISDIR}/linux-qoriq-4.14:"

SRC_URI_append += "file://ifc14xx_4_14_defconfig \
                   file://ifc14xx.dts \
...
do_merge_delta_config_prepend () {
    cp -a ${WORKDIR}/ifc14xx_4_14_defconfig  ${S}/arch/powerpc/configs/ifc14xx_defconfig
}
